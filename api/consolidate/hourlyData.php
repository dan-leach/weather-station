<?php
    ...
    $dt->modify('-1 hour');
    $lower = $dt->format('Y-m-d H:00:00'); //start of most recently completed hour
    $upper = $dt->format('Y-m-d H:59:59'); //end of most recently completed hour
